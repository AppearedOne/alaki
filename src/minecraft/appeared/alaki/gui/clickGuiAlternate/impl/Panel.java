...
public class Panel {
    ...
    public void drawIcon() {
        switch (category) {
            case COMBAT:
            	RenderUtil.drawImage(x + 3, y + 2, 12, 12, new ResourceLocation("alaki/icons/combat.png"), 200f);

                //Fonts.IconFont.drawStringWithShadow("c", x + 3, y + 2 + ((barHeight - Fonts.IconFont.getHeight()) / 2), -1);
                break;
            case MOVEMENT:
            	RenderUtil.drawImage(x + 1, y + 3, 12, 12, new ResourceLocation("alaki/icons/movement.png"), 200f);
                //Fonts.IconFont.drawStringWithShadow("n", x + 4.5, y + 2 + ((barHeight - Fonts.IconFont.getHeight()) / 2), -1);
                break;
            case PLAYER:
            	RenderUtil.drawImage(x + 2, y + 4, 9, 9, new ResourceLocation("alaki/icons/player.png"), 200f);
            	//Fonts.IconFont.drawStringWithShadow("p", x + 5.5, y + 2 + ((barHeight - Fonts.IconFont.getHeight()) / 2), -1);
                break;
            case RENDER:
            	RenderUtil.drawImage(x + 2, y + 3, 12, 12, new ResourceLocation("alaki/icons/visual.png"), 200f);
            	//Fonts.IconFont.drawStringWithShadow("i", x + 4, y + 2 + ((barHeight - Fonts.IconFont.getHeight()) / 2), -1);
                break;
            case EXPLOIT:
            	RenderUtil.drawImage(x + 3, y + 3, 11, 11, new ResourceLocation("alaki/icons/exploit.png"), 200f);
            	//Fonts.IconFont.drawStringWithShadow("e", x + 4.5, y + 2 + ((barHeight - Fonts.IconFont.getHeight()) / 2), -1);
                break;
            case GHOST:
            	RenderUtil.drawImage(x + 3, y + 3, 11, 11, new ResourceLocation("alaki/icons/ghost.png"), 200f);
            	//Fonts.IconFont.drawStringWithShadow("e", x + 4.5, y + 2 + ((barHeight - Fonts.IconFont.getHeight()) / 2), -1);
                break;
            case CLIENT:
            	RenderUtil.drawImage(x + 3, y + 3, 11, 11, new ResourceLocation("alaki/icons/client.png"), 200f);
            	//Fonts.IconFont.drawStringWithShadow("e", x + 4.5, y + 2 + ((barHeight - Fonts.IconFont.getHeight()) / 2), -1);
                break;
        }
    }
