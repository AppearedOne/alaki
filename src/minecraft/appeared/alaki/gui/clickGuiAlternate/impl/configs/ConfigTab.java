package appeared.alaki.gui.clickGuiAlternate.impl.configs;
...
import appeared.alaki.gui.clickGui.impl.configs.ConfigSelect;
...
public class ConfigTab {
    ...
    private void buttonClick(int num, String configName) {
        switch (num) {
            case 0:
                Alaki.configManager.loadConfig(configName,false);
                break;
            case 1:
                Alaki.configManager.saveConfig(configName);
                break;
        }
        update();
    }
