...
public class Keybind extends SetBase {
    public appeared.alaki.gui.clickGuiAlternate.impl.Button parent;
    public double y;
    ...
    public double drawScreen(int mouseX, int mouseY, float partialTicks, double settingHeight) {
        ...
        Fonts.apple18.drawStringWithShadow("Bind", x + 3, y + ((height - Fonts.SFReg18.getHeight()) / 2) + 0.5, -1);
        ...
        RenderUtil.drawRoundedRectangle(otherX, y + 2, otherX2, y + height - 2, 4, new Color(40,40,40, 200).getRGB());
