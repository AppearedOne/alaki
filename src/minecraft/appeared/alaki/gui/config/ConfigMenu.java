...
public class ConfigMenu extends GuiScreen {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        RenderUtil.drawOutlinedRoundedRect(x*6.15 + 3, y -anim + 280 + 10, width / 4.35, 30, 5,5, new Color(ColorUtil.getAstolfoColorSpeed(10000, 200, 70000f).getRed(),ColorUtil.getAstolfoColorSpeed(10000, 200, 70000f).getGreen(),ColorUtil.getAstolfoColorSpeed(10000, 200, 70000f).getBlue(), 130).getRGB());
