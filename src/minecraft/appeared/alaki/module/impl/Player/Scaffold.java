...
public class Scaffold extends Module {
	public ModeSetting mode = new ModeSetting("Mode", "Normal", "Vulcan", "Verus", "BMC");
    ...
    public Scaffold() {
        ...
        this.addSettings(mode, sprint, timer, jumpset, towerset, collide, preRots, postRots, JumpMode);
    ...
    public void onUpdate(UpdateEvent e) {
        ...
        if(blockCount > 0) {
        mc.playerController.onPlayerRightClick(player, world, player.getCurrentEquippedItem(), data.pos, data.face, hitVec);}
