...
public class ClickGUI extends Module  {
    ...
    public static ModeSetting clickGuiMode = new ModeSetting("ClickGUI","New","Old");
    public static BooleanSetting blr = new BooleanSetting("Blur", false);
    public static BooleanSetting wm = new BooleanSetting("Watermark", false);
    public ClickGUI(){
        super("ClickGUI", "The ClickGUI??", Category.CLIENT, ServerType.All);
        setKey(Keyboard.KEY_RSHIFT);
        wm.setParent(clickGuiMode, "New");
        blr.setParent(clickGuiMode, "New");
        this.addSettings(clickGuiMode,wm,blr ,clickGuiColorMode);
    }
    ...
    public void onEnable() {
        ...
        switch (clickGuiMode.getMode()){
            case "Old":
            	clickGuiModeStringVal = "Old";
                diabloGui.openClickGUI();
                break;

            case "New":
            	clickGuiModeStringVal = "New";
