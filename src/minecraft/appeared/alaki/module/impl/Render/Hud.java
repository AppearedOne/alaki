...
public class Hud extends Module {
    ...
    public static ModeSetting wtc = new ModeSetting("Color", "Alaki", "Alternative");
        ...
        switch (hudType.getMode()) {
            case "Alaki":
            	...
            	case "Alaki":
            		...
            		break;
            	case "Alternative":
            		RenderUtil.drawImage(-1, -1, 90, 60, new ResourceLocation("alaki/icons/Alaki2.png"));
            		break;
            	}
                break;
            case "Basic":
    ...
    private static void drawBackRGB() {
    	...
    	RenderUtil.drawRect(4, 8, 150, 25, new Color(1, 1, 1, 200).getRGB());
