...
public class Module {
    ...
    public boolean toggle() {
    	...
    	if(Notifications.ToggleNotify.getValue()) {
    		...
    		Alaki.getInstance().addNotification(new Notification("Toggled " + this.getName() + " " + toggleOnorOf, "", 1300, NotificationType.SUCCESS));		
    	}
    ...
    public void onEnable() {
        Alaki.eventBus.register(this);
    }

    public void onDisable() {
        mc.timer.timerSpeed = 1f;
        try{
        Alaki.eventBus.unregister(this);
