...
public class GuiMainMenu extends GuiScreen implements GuiYesNoCallback
{
    ...
    private void addButtons(int y) {
        ...
        String title = "By 0%simp, TheAppearedOne, V1per and MiningBedrock";
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        String loggedInStr = ChatColor.WHITE + "By 0%simp, TheAppearedOne, V1per and MiningBedrock";
        Fonts.SFReg24.drawStringWithShadow(Alaki.buildType + " " + Alaki.version, width / 1.9f - Fonts.SFReg24.getStringWidth(Alaki.buildType + " " + Alaki.version)/2f, height / 2.92f, 0xfFffffff);
        
        RenderUtil.drawImage(width/2 - width/17.6, height/3.8,(int) (width/8.8),width/11,new ResourceLocation("alaki/icons/Alaki1.png"),1);
